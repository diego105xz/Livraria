    ...
    try:
        ...
        if cursor.rowcount == 0:
            ...
            for idx, livro in enumerate(livros_disponiveis, start=1):
                ...
                print(f"{idx}. Título: {titulo:<50} Disponíveis: {disponiveis:>5}")
            ...
            if 1 <= livro_escolhido_numero <= len(livros_disponiveis):
                ...
                print("Matricula - Cliente:")
                for usuario in usuarios:
                    user_id, user_nome = usuario
                    print(f"{user_id:<9} - {user_nome}")
        ...
        print("Erro ao consultar os livros disponíveis:", error)